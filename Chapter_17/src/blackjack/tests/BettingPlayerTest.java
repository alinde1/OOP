 ...
 */
public class BettingPlayerTest extends TestCase {
    ...
    public void test_playHit() {
        ...
        // must get out of betting since play will call state.execute
        player.play( dealer );
        player.addCard( H_2 );
        player.addCard( H_2 );
        player.setHit( true );
    ...
    protected void setUp() {
        hand = new Hand();
        bank = new Bank( 1000 );
        player = new MockPlayer( "mp", hand, bank );
    ...
    public BettingPlayerTest(String name) {
        super( name );
    }
    ...
    private class MockDealer implements Dealer {
        ...
        private boolean done_betting = false;
        
        public boolean wasHit() {
            return was_hit;
        }
        
        public boolean wasDoneBetting() {
            return done_betting;
        }
