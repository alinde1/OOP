 ...
 * wait for the user to press a button. The GUIPlayer presents a view of
 * itself as well.
 * @author  Tony Sintes STYOOP
 */
public class GUIPlayer extends VBettingPlayer {

    private BlackjackDealer dealer;
    private JPanel view;
    
    public GUIPlayer( String name, VHand hand, Bank bank, BlackjackDealer dealer ) {
